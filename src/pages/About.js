  ...
  return (
    <div>
      <section className="bg-richblack-700">
        <div className="relative mx-auto flex w-9/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
      ...
      <section className="border-b border-richblack-700">
        <div className="mx-auto flex w-9/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
